...
class Register < Sinatra::Application
  ...
  post "/register" do
    user_name =  Security::String_Manager::destroy_script(params[:username]) #remove leading whitespaces and special characters
    ...
    redirect 'error/pwd_unsafe' unless Security::String_Manager::is_safe_pw?(user_pwd)
